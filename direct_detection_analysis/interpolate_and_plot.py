...
sheet_name = "150"              # Excel sheet name corresponding to radion mass
...
# === 8. Save plots ===
fig1.savefig(f"{sheet_name}.png", dpi=300, bbox_inches="tight")
print(f"Saved plots: {sheet_name}.png.png")
